-- ============================================================
-- INIT SCHEMA — pour Neon (PostgreSQL hébergé)
...
CREATE TABLE IF NOT EXISTS trails (
  ...
  -- Métriques (calculées depuis le GPX)
...
CREATE UNIQUE INDEX IF NOT EXISTS trails_source_idx ON trails(source, source_id)
...
-- Mise à jour automatique du vecteur full-text search
