            ...
            <div className="glass rounded-2xl p-2 flex items-center gap-2 max-w-lg">
              <div className="flex-1 flex items-center gap-3 px-4">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent text-[#111111] placeholder-gray-400 text-sm outline-none py-2"
                />
              </div>
              <Link
                href="/randonnees"
                className="bg-[#025C00] hover:bg-[#014800] text-white text-sm font-semibold px-5 py-3 rounded-xl transition-colors whitespace-nowrap"
              >
                Explorer
              </Link>
            </div>
        ...
        <ScrollReveal>
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <h2 className="text-3xl font-bold text-[#111111]">Randonnées sélectionnées</h2>
            </div>
            <Link
              href="/randonnees"
              className="hidden md:flex items-center gap-2 text-sm font-medium text-[#025C00] hover:text-[#014800] transition-colors group"
            >
            ...
            return (
              <ScrollReveal key={trail.id} delay={i * 80}>
                <Link href={href} className="group block bg-white rounded-2xl overflow-hidden border border-[#E5E7EB] hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="p-4">
                    <p className="text-xs text-gray-400 mb-1 font-medium">{trail.department_name}</p>
                    <h3 className="font-bold text-[#111111] text-[15px] leading-snug mb-2 line-clamp-2">
                      {trail.name}
                    </h3>
                    ...
                    <div className="flex items-center gap-3 pt-3 border-t border-[#F5F5F5] text-sm">
      ...
      <section className="bg-[#F5F5F5] py-20">
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            ...
            <h2 className="text-3xl font-bold text-[#111111] mb-10">Choisissez votre niveau</h2>
          </ScrollReveal>
            ...
            {[
              ...
              <ScrollReveal key={slug} delay={i * 60}>
                ...
                >
                  ...
                  <p className="font-bold text-[#111111] text-sm mb-1">{label}</p>
